...
- [x] T0-07: 不要ファイル・未使用定義の整理（旧メニュー/スプレッドUI削除）

---

## フェーズ1: Bot 最小UX（/start・メニュー・コマンド導線）
- [x] T1-01: `/start`（挨拶＋使い方）
- [x] T1-02: メニュー（占い / 相談 / チャージ / ステータス 等の導線／下部4ボタンに統一）
...
### 8-A Telegram内UX（最重要）
- [x] T8A-01: 最初の60秒UX（迷わせない：3タップで占い完了／下部4ボタンの一本道）
- [ ] T8A-02: 結果の見せ方（結論→理由→行動、読みやすさ最優先）
- [x] T8A-03: 続き導線（深掘り質問/3枚提案/次回予告：3枚アップセルボタン追加）
